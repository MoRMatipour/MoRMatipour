...
- Applying **Python** for data analysis and machine learning.
...
| [**Interactive Visualization of Minard’s Russian Campaign**](https://github.com/MoRMatipour/Minard-s-Russian-campaign-interactive-visualization/tree/main) | A modern, interactive recreation of Charles Minard’s famous 1812 Russian campaign map. Preserved the original narrative of troop movements, size, and temperature while enabling users to explore the data dynamically, blending historical storytelling with modern visualization techniques. | Flourish, Power BI, Interactive Visualization |
